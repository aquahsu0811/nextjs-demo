...
async function getStaticPaths() {
  ...
  try {
    client = await external_mongodb_["MongoClient"].connect('mongodb+srv://AquaAdmin:dUYonbpI2yOr2CjW@cluster0.6i4zscc.mongodb.net/meetups?retryWrites=true&w=majority');
  } catch (error) {
    console.log(error);
    return;
  }
